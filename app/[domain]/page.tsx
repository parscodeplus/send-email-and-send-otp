...
import MessageShow from "@/components/message-arr";
import CookingTimerApp from "@/components/test-time-countdown";
import React from "react";
import { QnAComponent } from "@/components/qn-AComponent";
// const QnAComponent = React.lazy(() => import("@/components/qn-AComponent"))
  ...
  async function onSubmit(datas: z.infer<typeof FormSchema>) {
    ...
    try {
      ...
      toast({
        title: "خطا",
        description:
          "خطایی در حین اعتبارسنجی OTP رخ داد. لطفا دوباره تلاش کنید.",
        variant: "destructive",
      });
    }
  }
